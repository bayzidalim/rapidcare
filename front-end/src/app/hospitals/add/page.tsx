              ...
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-6">
                    Your hospital registration has been submitted successfully. It will be reviewed by an admin and you'll be notified once approved. Redirecting to dashboard...
                  </p>
                  <Link href="/dashboard">
      ...
      <div className="min-h-screen">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Add New Hospital</h1>
            <p className="text-gray-600">
              Register a new hospital to the RapidCare platform and expand our emergency care network.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Provide your hospital's essential information to join the RapidCare emergency care network.
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Provide your hospital's complete address for accurate patient routing and emergency response.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Define your hospital's medical resource capacity to enable real-time availability tracking for emergency care.
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Select the specialized medical services your hospital provides to help patients find the right care quickly.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Hospital Rating</CardTitle>
                <CardDescription>
                  Set your hospital's quality rating to help patients make informed decisions during emergencies.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div>
