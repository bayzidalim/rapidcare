...
exports.createBloodRequest = async (req, res) => {
  try {
    ...
    const bloodRequest = await BloodRequestService.create(requestData);
...
exports.getAllBloodRequests = async (req, res) => {
  try {
    ...
    const bloodRequests = await BloodRequestService.search({ status, bloodType, urgency });
...
exports.getBloodRequestById = async (req, res) => {
  try {
    const bloodRequest = await BloodRequestService.getById(req.params.id);
...
exports.updateBloodRequestStatus = async (req, res) => {
  try {
    ...
    await BloodRequestService.updateStatus(id, status);
    const bloodRequest = await BloodRequestService.getById(id);
...
exports.matchDonor = async (req, res) => {
  try {
    ...
    await BloodRequestService.addMatchedDonor(id, donorData);
    const bloodRequest = await BloodRequestService.getById(id);
...
exports.updateDonorStatus = async (req, res) => {
  try {
    ...
    await BloodRequestService.updateDonorStatus(id, donorId, status);
    const bloodRequest = await BloodRequestService.getById(id);
...
exports.searchBloodRequests = async (req, res) => {
  try {
    ...
    const bloodRequests = await BloodRequestService.search({ bloodType, city, urgency });
...
exports.getCurrentUserBloodRequests = async (req, res) => {
  try {
    const bloodRequests = await BloodRequestService.search({ requesterId: req.user.id });
